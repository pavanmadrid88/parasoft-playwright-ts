...
export class AccountsOverviewPage extends BasePage{
    ...
    async getAccountIdDetails(){
       // await this.accountIdTableLinks.waitFor({ state: 'visible', timeout: 10000 });
        await this.waitUtils.isElementInteractable(this.accountIdTableLinks);
        //await this.accountsOverviewPage.waitForTimeout(5000); // timeout needed ; otherwise click doesn't succeed
